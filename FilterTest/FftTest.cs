...
namespace FilterTest
{
    ...
    public class FftTest
    {
        ...
        private void TestFftProviderComplex(IFftProvider provider)
        {
            ...
            ThrowsAssert.Throws<ArgumentNullException>(() => provider.ComplexFft(null));
            ThrowsAssert.Throws<ArgumentNullException>(() => provider.ComplexIfft(null));
        }
        ...
        private void TestFftProviderReal(IFftProvider provider)
        {
            ...
            ThrowsAssert.Throws<ArgumentNullException>(() => provider.RealFft(null));
            ThrowsAssert.Throws<ArgumentNullException>(() => provider.RealIfft(null));
        }
    }
}