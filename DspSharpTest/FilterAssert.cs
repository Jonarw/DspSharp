// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FilterAssert.cs">
...
namespace DspSharpTest
{
    internal static class FilterAssert
    {
        ...
        internal static void ListsAreReasonablyClose(
            IReadOnlyList<double> list1,
            IReadOnlyList<double> list2,
        ...
        internal static void ListsAreReasonablyClose(
            IReadOnlyList<Complex> list1,
            IReadOnlyList<Complex> list2,
